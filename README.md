...
```
2. Run QSAR_main.ipynb until the Markdown that says "Save the dataset"  (this is to extract all compounds from DrugBank and remove overlap with compounds present in ChEMBL)
3. Run the full ChEMBL_dataset_extraction.ipynb
4. Run the remaining of QSAR_main.ipynb 
